...
test("trend regime remains fixed before its scheduled end while EMA updates", () => {
  ...
  database.exec(`
    CREATE TABLE stocks (
      ...
      market_cap INTEGER,
      current_price INTEGER DEFAULT 600,
      total_shares INTEGER DEFAULT 1000000000,
      is_bluechip INTEGER DEFAULT 0,
      listed_at TEXT,
      initial_market_cap INTEGER,
      market_cap_ema_24h INTEGER,
      market_cap_ema_7d INTEGER,
      stability_market_cap INTEGER,
      stability_tier TEXT,
      stability_tier_candidate TEXT,
      stability_tier_candidate_since TEXT,
      stability_tier_entered_at TEXT,
      last_stability_update_at TEXT,
      trend_regime TEXT,
